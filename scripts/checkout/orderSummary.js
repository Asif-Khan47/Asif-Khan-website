...
export function renderOrderSummary() {
 ...
 ">
  ...
  <div class="cart-item-details">
    ...
    <div class="product-quantity">
      ...
      data-product-id="${matchingProduct.id}">
        ...
        link-primary js-save-link" data-product-id="${matchingProduct.id}">Save<span>
  ...
  document.querySelectorAll('.js-update-quntity-link').forEach((updateElem) => {
  ...
  document.querySelectorAll('.save-quantity-link').forEach((saveElem) => {
    saveElem.addEventListener('click', () => {
      const productId = saveElem.dataset.productId;

      document.querySelector(`.js-cart-item-container-${productId}`).classList.remove('is-editing-quantity');

      let inputLabel = document.querySelector('.myinput');
      let x = Number(inputLabel.value);
